...
- (void)viewDidLoad {
    ...
    _Definition = @[@"Scalare quantities fully describe magnitude. For example, 3 meters or 34°C",
                    ...
                    // expand on the 4 fundamental forces
                    @"A force is a push or a pull. \n\nThere are 4 fundamental forces in physics: \n1. The force of gravity \n2. The electromagnectic force \n3. The strong nuclear force \n4. The weak nuclear force",
                    @"An object will maintain its current state of motion unless acted upon by an external force.",
                    ...
                    @"An inclined plane is a surface thath is not parallel to the ground.",
                    @"Every particles in the universe exerts an attractive force on every other particle. A particle is a piece of matter, small enough in size to be reguarded as a mathematical point.",
                    @"Energy is the ability to do WORK. \nWork is the transfer of energy through the application of a force over a measured distance.",
                    @"Work occurs when a orce F is applied over a certain displacement Δd."];
